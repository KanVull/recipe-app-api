...
class PrivateRecipeAPITest(TestCase):
    ...
    def test_clear_recipe_indredients(self):
        """Test clearing a recipes ingredients."""
        ingredient = Ingredient.objects.create(user=self.user, name='Mayonese')
        recipe = create_recipe(user=self.user)
    ...
    def test_filter_by_tags(self):
        ...
        recipe1 = create_recipe(user=self.user, title='Thau Vagetable Curry')
    ...
    def test_filter_by_ingredients(self):
        ...
        recipe3 = create_recipe(user=self.user, title='Shashliki')
